...
export declare const chatSchema: import("@sinclair/typebox").TObject<{
    ...
    user: import("@sinclair/typebox").TRef<import("@sinclair/typebox").TObject<{
        ...
        auth0Id: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TString<string>>;
        avatar: import("@sinclair/typebox").TOptional<import("@sinclair/typebox").TString<string>>;
    }>>;
}>;
export type Chat = Static<typeof chatSchema>;
export declare const chatValidator: import("@feathersjs/schema").Validator<any, any>;
export declare const chatResolver: import("@feathersjs/schema").Resolver<{
    text: string;
    user: {
...
export declare const chatExternalResolver: import("@feathersjs/schema").Resolver<{
    text: string;
    user: {
        password?: string | undefined;
        googleId?: string | undefined;
...
export declare const chatDataSchema: import("@sinclair/typebox").TPick<import("@sinclair/typebox").TObject<{
    _id: import("@sinclair/typebox").TUnion<[import("@sinclair/typebox").TString<string>, import("@sinclair/typebox").TObject<{}>]>;
    text: import("@sinclair/typebox").TString<string>;
    createdAt: import("@sinclair/typebox").TNumber;
    userId: import("@sinclair/typebox").TString<string>;
...
export declare const chatDataValidator: import("@feathersjs/schema").Validator<any, any>;
export declare const chatDataResolver: import("@feathersjs/schema").Resolver<{
    text: string;
    user: {
        password?: string | undefined;
        googleId?: string | undefined;
...
export declare const chatPatchSchema: import("@sinclair/typebox").TPartial<import("@sinclair/typebox").TObject<{
    _id: import("@sinclair/typebox").TUnion<[import("@sinclair/typebox").TString<string>, import("@sinclair/typebox").TObject<{}>]>;
    text: import("@sinclair/typebox").TString<string>;
    createdAt: import("@sinclair/typebox").TNumber;
    userId: import("@sinclair/typebox").TString<string>;
...
export declare const chatPatchValidator: import("@feathersjs/schema").Validator<any, any>;
export declare const chatPatchResolver: import("@feathersjs/schema").Resolver<{
    text: string;
    user: {
        password?: string | undefined;
        googleId?: string | undefined;
...
export declare const chatQueryProperties: import("@sinclair/typebox").TPick<import("@sinclair/typebox").TObject<{
    _id: import("@sinclair/typebox").TUnion<[import("@sinclair/typebox").TString<string>, import("@sinclair/typebox").TObject<{}>]>;
    text: import("@sinclair/typebox").TString<string>;
    createdAt: import("@sinclair/typebox").TNumber;
    userId: import("@sinclair/typebox").TString<string>;
...
export declare const chatQuerySchema: import("@sinclair/typebox").TIntersect<[import("@sinclair/typebox").TIntersect<[import("@sinclair/typebox").TPartial<import("@sinclair/typebox").TObject<{
...
export declare const chatQueryValidator: import("@feathersjs/schema").Validator<any, any>;
export declare const chatQueryResolver: import("@feathersjs/schema").Resolver<Partial<{
    $limit: number;
    $skip: number;
    $sort: {
